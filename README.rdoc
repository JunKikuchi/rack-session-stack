...
セッション情報を書き込む場合は Memcache と RAWS::SDB 全てに書き込みます。

セッション情報を読み込む場合、最初に Memcache から読み込みます。データが取得出来れば Memcache のデータを使い、データが取得出来なかった場合は RAWS::SDB からデータを読み込んで使います。
